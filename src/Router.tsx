...
function ConfiguredAppRouter() {
  ...
  const rawUserRole = userProfile?.role?.toLowerCase();
  ...
  return (
    <Routes>
        ...
        >
          <Route index element={<AdminDashboardPage userProfile={userProfile} />} />
          <Route path="licensure-exams" element={<AdminLicensureExamsPage userProfile={userProfile} />} />
          <Route path="accounts" element={<AdminAccountsPage userProfile={userProfile} />} />
        </Route>
